                        ...
                        <form action="{{route('login')}}" method="post">
                            ...
                            <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                                <div class="flex items-center mr-auto">
                                    <input name="remember" type="checkbox" class="input border mr-2" id="remember-me">
                            ...
                            <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                                ...
                                <a href="{{route('register')}}"><button type="button" class="button button--lg w-full xl:w-32 text-gray-700 border border-gray-300 dark:border-dark-5 dark:text-gray-300 mt-3 xl:mt-0 align-top">Sign up</button><a>
                            </div>
