...
@endif
        ...
        <div class="intro-y box">
            <div class="p-5">
                <form action="{{route('fuel.transaction.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-12 gap-4 gap-y-5">
                        ...
                        <div class="intro-y col-span-3">
                            ...
                            <input type="text" name="remaining" value="{{ old('remaining')}}" class="input w-full border mt-2" placeholder="title">
                        </div>
                        <div class="intro-y col-span-3">
                            <label>Capacity</label>
                            <input type="text" name="capacity" value="{{ old('capacity')}}" class="input w-full border mt-2" placeholder="title">
                        </div>
                        <div class="intro-y col-span-3">
                            <label>MIN</label>
                            <input type="text" name="min" value="{{ old('min')}}" class="input w-full border mt-2" placeholder="title">
                        </div>
                        <div class="intro-y col-span-3">
                            <label>MAX</label>
                            <input type="text" name="max" value="{{ old('max')}}" class="input w-full border mt-2" placeholder="title">
                        </div>
