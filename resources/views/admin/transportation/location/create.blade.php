...
@endif
        ...
        <div class="intro-y box">
            <div class="p-5">
                <form action="{{route('transportation.location.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div id="transport" class="grid grid-cols-12 gap-4 gap-y-5">
                        ...
                        <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                            ...
                            <input type="text" name="latitude" value="{{ old('latitude')}}" class="input w-full border mt-2">
                        </div>
                        <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                            <label>Longitude</label>
                            <input type="text" name="longitude" value="{{ old('longitude')}}" class="input w-full border mt-2">
                        </div>
                        <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                            <label>Address</label>
                            <input type="text" name="address" value="{{ old('address')}}" class="input w-full border mt-2">
                        </div>
                        <div class="intro-y col-span-3">
                            <label>State</label>
                            <div class="mt-2">
                        ...
                        <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                            ...
                            <input type="text" name="additional_point_info" value="{{ old('additional_point_info')}}" class="input w-full border mt-2">
                        </div>
