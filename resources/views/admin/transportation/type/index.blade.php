...
<div class="layout-px-spacing">
    ...
    <div class="intro-y flex items-center mt-8">
        <h5 class="text-2xl text-theme-9 font-medium leading-none">Tranportation Type</h5>
    </div>
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0 ">
        <a href="#" data-toggle="modal" data-target="#new_transportation" class="ml-auto mr-2">
            <button type="button" class="button text-white bg-theme-1 shadow-md mr-2 ml-auto">
                Add New
            </button>
        </a>
        <div class="modal" id="new_transportation">
            <div class="modal__content" style="width:50%;">
                ...
                <form action="{{route('transportation.type.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                        <div class="col-span-12 sm:col-span-6"> 
                            <label>Title</label> 
                            <input type="text" name="title" class="input w-full border"> 
                        </div> 
                        <div class="col-span-12 sm:col-span-6"> 
                            <label>Company</label> 
                            <select  name="company_id"  data-search="true" class="tail-select w-full" required="required">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a href="{{ route('transportation.type.destroy', $temp->id)}}" onclick="return confirm('Are You Really?');" class="flex items-center text-theme-6 mr-3">
                                    ...
                                    <div class="modal" id="item_edit{{$i}}">
                                        <div class="modal__content" style="width:50%;">
                                            <div class="flex items-center px-5 py-4 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                                                <h2 class="font-medium text-base mr-auto text-theme-1">New Type</h2>
                                            </div>
                                            <form action="{{route('transportation.type.update', $temp->id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Title</label> 
                                                        <input value="{{$temp->title}}" name="title" type="text" name="contract_num" class="input w-full border"> 
                                                    </div> 
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Company</label> 
                                                        <select  name="company_id"  data-search="true" class="tail-select w-full" required="required">
