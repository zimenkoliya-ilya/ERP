...
@endif
                <div class="intro-y flex items-center mt-8">
                    <h4 class="leading-none">Create Transport Job</h4>
                </div>
        <div class="intro-y box">
            <div class="p-5">
                <form action="{{route('transportation.list.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div id="transport" class="grid grid-cols-12 gap-4 gap-y-5">
                        <div class="intro-y col-span-3">
                            <label>Date*</label>
                            <input  name="date" value="{{ old('date')}}" type="date" class="input w-full border mt-2 block" placeholder="Transaction Date" autocomplete="off" required="required">
                        </div>
                        <div class="intro-y col-span-3">
                            <label>Company</label>
                            <div class="mt-2">
                        ...
                        <div class="intro-y col-span-3 mt-1">
                            <label class="mt-3">Scheduled Destination Datetime</label>
                            <input type="datetime-local" name="scheduled_datetime" value="{{ old('destinc_date')}}" class="input w-56 border block mx-auto" data-single-mode="true">
                        </div>
                        <div class="intro-y col-span-3">
