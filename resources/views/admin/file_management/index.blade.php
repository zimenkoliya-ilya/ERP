                ...
                <div class="w-full sm:w-auto flex">
                    ...
                    <div class="modal" id="new_contract">
                        <div class="modal__content" style="width:50%;">
                            ...
                            <form action="{{ route('file_management.image_upload')}}" method="post" enctype="multipart/form-data">
                                @csrf
                    ...
                    <div class="dom_remove{{$temp->id}} intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                        <div id="shared{{$temp->id}}" class="{{($temp->shared==1)?'bg-theme-9':''}} file box rounded-md px-1 pt-8 pb-3 px-3 sm:px-5 relative zoom-in">
                            <div class="absolute left-0 top-0 mt-3 ml-3">
                                <input  name="file_id[]" class="input border border-gray-500" type="checkbox" value="{{$temp->id}}">
                            </div>
                            <a href="#" class="w-3/5 file__icon file__icon--image mx-auto">
                                <div class="file__icon--image__preview image-fit">
                                    <img alt="Midone Tailwind HTML Admin Template" src="{{ asset(($temp->file)?$temp->file:'dist/images/preview-12.jpg')}}">
                                </div>
                            </a>
                            <a href="#" class="block font-medium mt-4 text-center truncate">{{$temp->name}}.{{$temp->extension}}</a> 
                            ...
                            <div class="absolute top-0 right-0 mr-2 mt-2 dropdown ml-auto" style="position:fixed;">
                                <a class="dropdown-toggle w-5 h-5 block" href="javascript:;"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical w-5 h-5 text-gray-600"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg> </a>
                                <div class="dropdown-box w-40">
                                    <div class="dropdown-box__content box dark:bg-dark-1 p-2">
                                        <a href="#" id="{{$temp->id}}"  class="shared flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users w-4 h-4 mr-2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> Share File </a>
