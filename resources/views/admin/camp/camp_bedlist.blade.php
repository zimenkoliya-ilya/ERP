...
<div class="layout-px-spacing">
    <div class="intro-y flex items-center mt-8">
        <h5 class="text-2xl text-theme-9 font-medium leading-none">Bed Lists</h5>
    </div>
        ...
        <div class="modal" id="new_category">
            <div class="modal__content" style="width:50%;">
                <div class="flex items-center px-5 py-4 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                    <h2 class="font-medium text-base mr-auto text-theme-1">Create New Bed</h2>
                </div>
                <form action="{{route('camp.bedlist.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12 sm:col-span-6"> 
                            <label>Room</label>
                            <select data-search="true" class="tail-select w-full mt-2" name="room_id" style="width:100%;">
                            ...
                            <tr>
                                    ...
                                    <div class="flex justify-center items-center">
                                        <a href="#" class="flex items-center text-theme-9 mr-3"> 
                                            <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                                                <input {{($temp->active==1)?'checked':''}} data-target="#radio" class="show-code input input--switch border" type="checkbox" onclick="bed_active({{$temp->id}}, {{$temp->active}})">
                                            </div>
                                        </a>
                                    </div>
                                </td>    
                                <td>
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a href="{{ route('camp.bedlist.destroy', $temp->id)}}"  onclick="return confirm('Really');"  class="flex items-center text-theme-6 mr-3" href="javascript:;">
                                    ...
                                    <div class="modal" id="new_category{{$i}}">
                                        <div class="modal__content" style="width:50%;">
                                            <div class="flex items-center px-5 py-4 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                                                <h2 class="font-medium text-base mr-auto text-theme-1">Update Bed</h2>
                                            </div>
                                            <form action="{{route('camp.bedlist.update', $temp->id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Title</label> 
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Room</label>
                                                        <select data-search="true" class="tail-select w-full mt-2" name="room_id" style="width:100%;">
                                                            @foreach($ct_room as $tempp)
                                                                @if($temp->room_id == $tempp->id)
