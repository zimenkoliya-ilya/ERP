...
@endif
                ...
                <form action="{{route('camp.loglist.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="intro-y grid grid-cols-12 sm:gap-6 gap-y-6 box px-5 py-8 mt-5">
                    ...
                    <div id="checkin" class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                        ...
                        <input value="{{ old('checkin')}}" name="checkin" class="datepicker input w-56 border block mx-auto" data-single-mode="true" style="width:100%;">
                    </div>
                    <div id="checkout" class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                        <label>Check Out Date</label>
                        <input value="{{ old('checkout')}}" name="checkout" class="datepicker input w-56 border block mx-auto" data-single-mode="true" style="width:100%;">
                    </div>
...
@section('script')
    <script>
        $(document).ready(function () {
            ...
            $(document).on('change','#bedget',function() {
