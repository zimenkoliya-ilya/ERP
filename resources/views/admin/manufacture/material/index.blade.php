...
<div class="layout-px-spacing">
    <div class="intro-y flex items-center mt-8">
        <h5 class="text-2xl font-medium leading-none">Product Material</h5>
    </div>
        ...
        <div class="modal" id="new_category">
            <div class="modal__content" style="width:50%;">
                <div class="flex items-center px-5 py-4 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                    <h2 class="font-medium text-base mr-auto text-theme-1">Create New Material</h2>
                </div>
                <form action="{{route('manufacture.material.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12 sm:col-span-6"> 
                            <label>Product</label>
                            <select data-search="true" class="tail-select w-full mt-2"  name="product_id" style="width:100%;">
                        ...
                        <div class="col-span-12 sm:col-span-6"> 
                            <label>Storage</label>
                            <select data-search="true" class="tail-select w-full mt-2"  name="storage_id" style="width:100%;">
                        ...
                        <div class="col-span-12 sm:col-span-6"> 
                            <label>Item</label>
                            <select data-search="true" class="tail-select w-full mt-2"  name="item_id" style="width:100%;">
                        ...
                        <div class="col-span-12 sm:col-span-6"> 
                            ...
                            <input type="text" name="quantity" value="{{ old('quantity')}}" class="input w-full border mt-2">
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a href="{{ route('manufacture.material.destroy', $temp->id)}}"  onclick="return confirm('Really');"  class="flex items-center text-theme-6 mr-3" href="javascript:;">
                                    ...
                                    <div class="modal" id="new_category{{$i}}">
                                        <div class="modal__content" style="width:50%;">
                                            ...
                                            <form action="{{route('manufacture.material.update', $temp->id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Company</label>
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Product</label>
                                                        <select data-search="true" class="tail-select w-full mt-2"  name="product_id" style="width:100%;">
                                                            @foreach($product as $tempp)
                                                                @if($tempp->id == $temp->product_id)
                                                                    <option value="{{$tempp->id}}" selected>{{$tempp->title}}</option>
                                                                @else
                                                                    <option value="{{$tempp->id}}">{{$tempp->title}}</option>
                                                                @endif
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Storage</label>
                                                        <select data-search="true" class="tail-select w-full mt-2"  name="storage_id" style="width:100%;">
                                                            @foreach($storage as $tempp)
                                                                @if($tempp->id == $temp->storage_id)
                                                                    <option value="{{$tempp->id}}" selected>{{$tempp->title}}</option>
                                                                @else
                                                                    <option value="{{$tempp->id}}">{{$tempp->title}}</option>
                                                                @endif
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Item</label>
                                                        <select data-search="true" class="tail-select w-full mt-2"  name="item_id" style="width:100%;">
                                                            @foreach($item as $tempp)
                                                                @if($tempp->id == $temp->item_id)
                                                                    <option value="{{$tempp->id}}" selected>{{$tempp->title}}</option>
                                                                @else
                                                                    <option value="{{$tempp->id}}">{{$tempp->title}}</option>
                                                                @endif
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Quantity</label> 
                                                        <input type="text" name="quantity" value="{{ $temp->quantity}}" class="input w-full border mt-2">
                                                    </div> 
                                                </div>
                                                <div class="px-5 py-3 text-right border-t border-gray-200 dark:border-dark-5"> 
                                                    <button type="submit" class="button w-20 bg-theme-1 text-white">Submit</button> 
