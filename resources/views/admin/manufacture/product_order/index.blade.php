...
<div class="layout-px-spacing">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0 ">
        <a href="{{route('manufacture.product_order.create')}}" class="ml-auto mr-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-center items-center">
                                        <a href="{{ route('manufacture.product_order.edit',$temp->id)}}" class="flex items-center text-theme-1 mr-3" href="javascript:;">
                                        ...
                                        <a href="{{ route('manufacture.product_order.destroy',$temp->id)}}" onclick="return confirm('Really?');" class="flex items-center text-theme-6 mr-3" href="javascript:;">
