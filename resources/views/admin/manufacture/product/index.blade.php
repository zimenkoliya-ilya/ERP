    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0 ">
        ...
        <div class="modal" id="new_category">
            <div class="modal__content" style="width:50%;">
                ...
                <form action="{{route('manufacture.product.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                        <div class="col-span-12 sm:col-span-6"> 
                            <label>Product Code</label> 
                            <input type="text" name="product_code" value="{{ old('product_code')}}" class="input w-full border mt-2">
                        </div> 
                        <div class="col-span-12 sm:col-span-6"> 
                            <label>Title</label> 
                        ...
                        <div class="col-span-12 sm:col-span-6"> 
                            ...
                            <select data-search="true" class="tail-select w-full mt-2"  name="category_id" style="width:100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a href="{{ route('manufacture.product.destroy', $temp->id)}}"  onclick="return confirm('Really');"  class="flex items-center text-theme-6 mr-3" href="javascript:;">
                                    ...
                                    <div class="modal" id="new_category{{$i}}">
                                        <div class="modal__content" style="width:50%;">
                                            ...
                                            <form action="{{route('manufacture.product.update', $temp->id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Product Code</label> 
                                                        <input type="text" name="product_code" value="{{ $temp->product_code}}" class="input w-full border mt-2">
                                                    </div> 
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Title</label> 
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Category</label>
                                                        <select data-search="true" class="tail-select w-full mt-2"  name="category_id" style="width:100%;">
                                                            @foreach($category as $tempp)
                                                                @if($tempp->id == $temp->category_id)
