...
<div class="layout-px-spacing">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0 ">
        <a href="#" data-toggle="modal" data-target="#new_item_type" class="ml-auto mr-2">
            <button type="button" class="button text-white bg-theme-1 shadow-md mr-2 ml-auto">
                Add New
            </button>
        </a>
        <div class="modal" id="new_item_type">
            <div class="modal__content" style="width:50%;">
                ...
                <form action="{{route('warehouse.item_type.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a href="{{ route('warehouse.item_type.destroy', $temp->id)}}" onclick="return confirm('Are You Really?');" class="flex items-center text-theme-6 mr-3">
                                    ...
                                    <div class="modal" id="item_edit{{$i}}">
                                        <div class="modal__content" style="width:50%;">
                                            ...
                                            <form action="{{route('warehouse.item_type.update', $temp->id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Title</label> 
