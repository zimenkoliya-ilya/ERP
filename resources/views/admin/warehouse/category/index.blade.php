...
<div class="layout-px-spacing">
    ...
    <div class="intro-y flex items-center mt-8">
        <h5 class="text-2xl font-medium leading-none">Category</h5>
    </div>
        ...
        <div class="modal" id="new_category">
            <div class="modal__content" style="width:50%;">
                <div class="flex items-center px-5 py-4 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                    <h2 class="font-medium text-base mr-auto text-theme-1">Category</h2>
                </div>
                <form action="{{route('warehouse.category.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a href="{{ route('warehouse.category.destroy', $temp->id)}}" onclick="return confirm('Are You Really?');" class="flex items-center text-theme-6 mr-3">
                                    ...
                                    <div class="modal" id="item_edit{{$i}}">
                                        <div class="modal__content" style="width:50%;">
                                            ...
                                            <form action="{{route('warehouse.category.update', $temp->id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Title</label> 
