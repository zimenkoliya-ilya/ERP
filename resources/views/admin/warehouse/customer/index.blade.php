...
<div class="layout-px-spacing">
    <div class="intro-y flex items-center mt-8">
        <h5 class="text-2xl font-medium leading-none">Customer Lists</h5>
    </div>
        ...
        <div class="modal" id="new_category">
            <div class="modal__content" style="width:50%;">
                <div class="flex items-center px-5 py-4 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                    <h2 class="font-medium text-base mr-auto text-theme-1">Create New Customer</h2>
                </div>
                <form action="{{route('warehouse.customer.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                        <div class="col-span-12 sm:col-span-6"> 
                            <label>Customer Name</label> 
                            <input type="text" name="customer_name" value="{{ old('customer_name')}}" class="input w-full border mt-2">
                        </div>
                        <div class="col-span-12 sm:col-span-6"> 
                            <label>Customer Code</label> 
                            <input type="text" name="customer_code" value="{{ old('customer_code')}}" class="input w-full border mt-2">
                        </div>
                        <div class="col-span-12 sm:col-span-6"> 
                            <p>Company</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a href="{{ route('warehouse.customer.destroy', $temp->id)}}"  onclick="return confirm('Really');"  class="flex items-center text-theme-6 mr-3" href="javascript:;">
                                    ...
                                    <div class="modal" id="new_category{{$i}}">
                                        <div class="modal__content" style="width:50%;">
                                            <div class="flex items-center px-5 py-4 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                                                <h2 class="font-medium text-base mr-auto text-theme-1">Update Customer</h2>
                                            </div>
                                            <form action="{{route('warehouse.customer.update', $temp->id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Customer Name</label> 
                                                        <input type="text" name="customer_name" value="{{$temp->customer_name}}" class="input w-full border mt-2">
                                                    </div>
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Customer Code</label> 
                                                        <input type="text" name="customer_code" value="{{$temp->customer_code}}" class="input w-full border mt-2">
                                                    </div>
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <p>Company</p>
                                                        <select data-search="true" class="tail-select w-full mt-2" name="company_id" style="width:100%;">
