...
@endif
        ...
        <form action="{{route('equipment.technic_list.update', $technic->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="intro-y grid grid-cols-12 sm:gap-6 gap-y-6 box px-5 py-8 mt-5">
                <div class="col-span-12 sm:col-span-4 xl:col-span-3 flex flex-col justify-end items-center">
                    <div class="upload mt-4 pr-md-4" style="width:200px;">
                        <input type="file" id="input-file-max-fs" name = "image" class="dropify" data-default-file="{{asset($technic->image)}}" data-max-file-size="5M" />
                ...
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>Company</label>
                    <select onchange="company_change(this)" data-search="true" class="tail-select w-full" name="company_id" style="width:100%;">
                        @foreach($zg_company as $temp)
                            @if($technic->company_id == $temp->id)
                ...
                <div id="customer" class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    ...
                    <select data-search="true" class="tail-select w-full" name="customer_id" style="width:100%;">
                        @foreach($customer as $temp)
                            @if($technic->customer_id == $temp->id)
                            <option value="{{$temp->id}}" selected>{{$temp->customer_name}}</option>
                            @else
                ...
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    ...
                    <select data-search="true" class="tail-select w-full" name="model_id" style="width:100%;">
                        @foreach($model as $temp)
                            @if($technic->model_id == $temp->id)
                            <option value="{{$temp->id}}" selected>{{$temp->model}}</option>
                            @else
                ...
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    ...
                    <select data-search="true" class="tail-select w-full"  name="category_id" style="width:100%;">
                        @foreach($category as $temp)
                            @if($technic->category_id == $temp->id)
                            <option value="{{$temp->id}}" selected>{{$temp->title}}</option>
                            @else
                            <option value="{{$temp->id}}">{{$temp->title}}</option>
                            @endif
                ...
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>ID Card №</label>
                    <input type="text" name="id_card_num" value="{{ $technic->id_card_num}}" class="input w-full border mt-2" placeholder="title">
                </div>
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>Plate Number</label>
                    <input type="text" name="plate_num" value="{{$technic->plate_num}}" class="input w-full border mt-2" placeholder="title">
                </div>
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>Park Number</label>
                    <input type="text" name="park_num" value="{{ $technic->park_num}}" class="input w-full border mt-2" placeholder="title">
                </div>
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    ...
                    <select data-search="true" class="tail-select w-full"  name="owner_status_id" style="width:100%;">
                        @foreach($owner_status as $temp)
                            @if($technic->owner_status_id == $temp->id)
                            <option value="{{$temp->id}}" selected>{{$temp->title}}</option>
                            @else
                            <option value="{{$temp->id}}" >{{$temp->title}}</option>
                            @endif
                ...
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    ...
                    <select data-search="true" class="tail-select w-full"  name="owner_company_id" style="width:100%;">
                        @foreach($zg_company as $temp)
                            @if($technic->owner_company_id == $temp->id)
                            <option value="{{$temp->id}}" selected>{{$temp->title}}</option>
                            @else
                            <option value="{{$temp->id}}" >{{$temp->title}}</option>
                            @endif
                ...
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    ...
                    <select data-search="true" class="tail-select w-full"  name="manufactured_country_id" style="width:100%;">
                        @foreach($country as $temp)
                            @if($technic->manufactured_country_id == $temp->id)
                            <option value="{{$temp->id}}" selected>{{$temp->title}}</option>
                            @else
                            <option value="{{$temp->id}}" >{{$temp->title}}</option>
                            @endif
                ...
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    ...
                    <input value="{{ $technic->manufactured_date}}" name="manufactured_date" class="datepicker input w-56 border block mx-auto" data-single-mode="true" style="width:100%;">
                </div>
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>Engine Number</label>
                    <input type="text" name="engine_num" value="{{ $technic->engine_num}}" class="input w-full border mt-2" placeholder="title">
                </div>
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>VIN Number</label>
                    <input type="text" name="vin_num" value="{{ $technic->vin_num}}" class="input w-full border mt-2" placeholder="title">
                </div>   
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>Color</label>
                    <input type="text" name="color" value="{{ $technic->color}}" class="input w-full border mt-2" placeholder="title">
                </div>
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>Started Using Date</label>
                    <input value="{{ $technic->start_date}}" name="start_date" class="datepicker input w-56 border block mx-auto" data-single-mode="true" style="width:100%;">
                </div>
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>Motor Power</label>
                    <input type="text" name="motor_power" value="{{ $technic->motor_power}}" class="input w-full border mt-2" placeholder="title">
                </div>
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>Weight(Kg)</label>
                    <input type="number" min="0" max="100000" step="0.001" name="weight_kg" value="{{ $technic->weight_kg}}" class="input w-full border mt-2" placeholder="title">
                </div>
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>Load Capacity</label>
                    <input type="number" min="0" max="100000" step="0.001" name="load_capacity" value="{{ $technic->load_capacity}}" class="input w-full border mt-2" placeholder="title">
                </div>
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    ...
                    @foreach($load_measurement as $temp)
                        @if($technic->load_capacity_measurement_id == $temp->id)
                        <option value="{{$temp->id}}" selected>{{$temp->title}}</option>
                        @else
                        <option value="{{$temp->id}}">{{$temp->title}}</option>
                        @endif
                ...
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>Seat</label>
                    <input type="number" name="seat" value="{{ $technic->seat}}" class="input w-full border mt-2" placeholder="title">
                </div>
                <div class="col-span-6 sm:col-span-6 xl:col-span-3 flex flex-col justify-end items-center">
                    <label>Active</label>
