...
<div class="layout-px-spacing">
    <div class="intro-y flex items-center mt-8">
        <h5 class="text-2xl font-medium leading-none">Department Lists</h5>
    </div>
    ...
    <div class="modal" id="new_category">
        <div class="modal__content" style="width:50%;">
            <div class="flex items-center px-5 py-4 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                <h2 class="font-medium text-base mr-auto text-theme-1">Create New Blood Type</h2>
            </div>
            <form action="{{route('setting.department.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="col-span-12 sm:col-span-6"> 
                        <label>Tushaal</label> 
                        <input type="text" name="tushaal_title" value="{{ old('tushaal_title')}}" class="input w-full border mt-2">
                    </div> 
                    <div class="col-span-12 sm:col-span-6"> 
                        <label>ID Card Number</label> 
                        <input type="text" name="id_card_num" value="{{ old('id_card_num')}}" class="input w-full border mt-2">
                    </div> 
                </div>
                            ...
                            <tr>
                                    ...
                                    <div class="flex justify-center items-center">
                                        <a href="#" class="flex items-center text-theme-9 mr-3"> 
                                            <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                                                <input {{($temp->active==1)?'checked':''}} data-target="#radio" class="show-code input input--switch border" type="checkbox" onclick="department_active({{$temp->id}}, {{$temp->active}})">
                                            </div>
                                        </a>
                                    </div>
                                </td> 
                                <td>
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a href="{{ route('setting.department.destroy', $temp->id)}}"  onclick="return confirm('Really');"  class="flex items-center text-theme-6 mr-3" href="javascript:;">
                                    ...
                                    <div class="modal" id="new_category{{$i}}">
                                        <div class="modal__content" style="width:50%;">
                                            ...
                                            <form action="{{route('setting.department.update', $temp->id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Company</label>
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Tushaal</label> 
                                                        <input type="text" name="tushaal_title" value="{{ $temp->tushaal_title}}" class="input w-full border mt-2">
                                                    </div> 
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>ID Card Number</label> 
                                                        <input type="text" name="id_card_num" value="{{ $temp->id_card_num}}" class="input w-full border mt-2">
                                                    </div> 
                                                </div>
                                                <div class="px-5 py-3 text-right border-t border-gray-200 dark:border-dark-5"> 
                                                    <button type="submit" class="button w-20 bg-theme-1 text-white">Submit</button> 
...
@section('script')
    <script>
        ...
        function department_active(id, value){
            var set_start = value;
            $.ajax({
                type:'POST',
                url:'/setting/department/active',
