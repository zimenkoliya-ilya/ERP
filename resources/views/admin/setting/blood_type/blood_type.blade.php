...
<div class="layout-px-spacing">
    <div class="intro-y flex items-center mt-8">
        <h5 class="text-2xl font-medium leading-none">Blood Type Lists</h5>
    </div>
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0 ">
        ...
        <div class="modal" id="new_category">
            <div class="modal__content" style="width:50%;">
                ...
                <form action="{{route('setting.blood_type.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                        <div class="col-span-12 sm:col-span-6"> 
                            <label>Blood Type Name</label> 
                            <input type="text" name="blood_type" value="{{ old('blood_type')}}" class="input w-full border mt-2">
                        </div> 
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a href="{{ route('setting.blood_type.destroy', $temp->id)}}"  onclick="return confirm('Really');"  class="flex items-center text-theme-6 mr-3" href="javascript:;">
                                    ...
                                    <div class="modal" id="new_category{{$i}}">
                                        <div class="modal__content" style="width:50%;">
                                            <div class="flex items-center px-5 py-4 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                                                <h2 class="font-medium text-base mr-auto text-theme-1">Blood Type</h2>
                                            </div>
                                            <form action="{{route('setting.blood_type.update', $temp->id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                    <div class="col-span-12 sm:col-span-6"> 
                                                        <label>Blood Type</label> 
                                                        <input type="text" name="blood_type" value="{{ $temp->title}}" class="input w-full border mt-2">
                                                    </div> 
                                                </div>
                                                <div class="px-5 py-3 text-right border-t border-gray-200 dark:border-dark-5"> 
                                                    <button type="submit" class="button w-20 bg-theme-1 text-white">Submit</button> 
